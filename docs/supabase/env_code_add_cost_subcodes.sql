...
VALUES ('6030001', 'cost', 'COST_0100', 1, 6030001, '급여-임원', ARRAY['급여-임원'])
...
INSERT INTO public.env_code (code, category, parent_code, "order", value, title, param)
VALUES ('6030002', 'cost', 'COST_0100', 2, 6030002, '급여-직원', ARRAY['급여-직원'])
ON CONFLICT (code) DO UPDATE SET
  category = EXCLUDED.category,
  parent_code = EXCLUDED.parent_code,
  "order" = EXCLUDED."order",
...
INSERT INTO public.env_code (code, category, parent_code, "order", value, title, param)
VALUES ('6050001', 'cost', 'COST_0100', 3, 6050001, '상여금-임원', ARRAY['상여금-임원'])
ON CONFLICT (code) DO UPDATE SET
  category = EXCLUDED.category,
  parent_code = EXCLUDED.parent_code,
  "order" = EXCLUDED."order",
...
INSERT INTO public.env_code (code, category, parent_code, "order", value, title, param)
VALUES ('6070000', 'cost', 'COST_0100', 4, 6070000, '퇴직급여', ARRAY['퇴직급여'])
ON CONFLICT (code) DO UPDATE SET
  category = EXCLUDED.category,
  parent_code = EXCLUDED.parent_code,
  "order" = EXCLUDED."order",
