...
-- 컬럼 코멘트
COMMENT ON COLUMN public.ev_sales.excel_file_id IS '엑셀 파일 ID (Storage 경로)';
COMMENT ON COLUMN public.ev_sales.excel_file_name IS '엑셀 파일명 (원본 파일명)';
COMMENT ON COLUMN public.ev_sales.excel_uploaded_at IS '엑셀 파일 업로드 일시';
