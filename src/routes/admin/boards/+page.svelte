<script>
	...
	import BoardManagementTab from '$lib/components/admin/BoardManagementTab.svelte';
...
<svelte:head>
	<title>A-게시판 관리 - {___prjConst.oAuth.appName}</title>
</svelte:head>
		...
		<main class="admin-main">
			<div class="container">
				<div class="page-header">
					<h1>A-게시판 관리</h1>
					<p>게시판과 게시물을 관리할 수 있는 관리 기능을 제공합니다</p>
				</div>
