<script>
	...
	import CategoryTab from '$lib/components/admin/CategoryTab.svelte';
...
<svelte:head>
	<title>A-일정 카테고리 관리 - {___prjConst.oAuth.appName}</title>
</svelte:head>
		...
		<main class="admin-main">
			<div class="container">
				<div class="page-header">
					<h1>A-일정 카테고리 관리</h1>
					<p>일정 카테고리를 생성, 수정, 삭제할 수 있는 관리 기능을 제공합니다</p>
				</div>
